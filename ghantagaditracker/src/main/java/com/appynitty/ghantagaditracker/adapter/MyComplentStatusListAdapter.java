    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (!AUtils.isNull(complentStatusPojoList) && !complentStatusPojoList.isEmpty()) {
            ...
            if (!AUtils.isNullString(complentStatusPojo.getRefId())) {
                holder.refrenceIdTextView.setText(String.format("%s : %s", context.getString(R.string.grievance_id), complentStatusPojo.getRefId()));
            } else {
            ...
            if (!AUtils.isNullString(complentStatusPojo.getStatus())) {
                holder.dateTextView.setText(String.format("%s : %s", context.getString(R.string.date), complentStatusPojo.getCreatedDate()));
            } else {
