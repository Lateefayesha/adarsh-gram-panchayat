...
public class UtilityListAdapter extends ArrayAdapter<String> {
...
//        settingItemList.add(getString(R.string.bloodbank));
//        settingItemList.add(getString(R.string.newspaper));
            ...
            R.drawable.ic_jobs,
//            R.drawable.ic_blood_bank,
            R.drawable.ic_newspaper,
            R.drawable.ic_zilla_parishad,
            R.drawable.ic_tahasil
    };
    ...
    public UtilityListAdapter(Context context, List<String> mainMenuPojoList) {
